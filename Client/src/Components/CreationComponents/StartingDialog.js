...
const StartingDialog = () => {
  ...
  const MainDialog = () => {
    return (
      <Box>
        <DialogTitle color={COLORS.black}>
        ...
        <DialogContent>
          <Box>
            {state.dialogPage === "start" ? (
              <Stack direction="row" spacing={2} p={{ xs: 0, md: 2 }} my={2}>
                <Paper sx={{ flex: 1 }}>
  ...
  const VerificationGPDialog = () => {
    ...
    return (
      <>
        ...
        <DialogContent>
          <DialogContentText>
            Certaines de vos informations ne sont validées, veuillez les
            verifier avant de créer une annonce
          </DialogContentText>
          <Box py={2} px={2}>
            <List>
              <ListItemButton
                ...
                onClick={() =>
                  history.push(
                    "/profilDetails/" + currentUser?.uid + "/documents"
                  )
                }
              >
                <ListItem disableGutters>
                  <ListItemText>
                    {getVerificationLabel(state?.user?.documentIdentity)}
                  </ListItemText>
                  <ListItemIcon>
          ...
          <Typography variant="caption">
            La vérification du numéro est facultative pour créer une annonce,
            mais obligatoire pour la suite.
          </Typography>
        </DialogContent>
      </>
    );
  ...
  const BecomeGpDialog = () => {
    return (
      <>
        ...
        <DialogContent>
          <DialogContentText>
            Vous avez un compte client, veuillez devenir un covaliseur en
            quelques clics.
          </DialogContentText>
          <Stack
            direction="row"
