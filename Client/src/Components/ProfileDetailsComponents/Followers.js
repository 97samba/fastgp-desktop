    ...
    return (
      <>
        <Stack direction="row" spacing={2} alignItems="center" py={2}>
          <Link href={"/profilDetails/" + person.userId + "/myProfile"}>
            <Avatar src={person.photoUrl} alt={"fast-gp-" + person.firstname} />
          </Link>
          <Stack flexGrow={1}>
          ...
          {person.followers.includes(userId) ? (
            ...
            <Button size="small" variant="contained" endIcon={<IoAdd />}>
              S'abonner
            </Button>
          )}
        </Stack>
        ...
        {loading ? (
          ...
          <Box>
            {followers.length > 0 ? (
              ...
              <Box>
                <Typography>Vous n'avez pas d'abonné</Typography>
              </Box>
            )}
          </Box>
        )}
          ...
          <Box>
            {followed.length > 0 ? (
              ...
              <Box py={4} px={2} textAlign="center">
                <Typography>Vous ne suivez aucun GP.</Typography>
              </Box>
            )}
          </Box>
        )}
