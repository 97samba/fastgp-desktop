                ...
                <Grid container mb={1} rowSpacing={2} columnSpacing={4}>
                  <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                    <TextField
                      ...
                      helperText={
                        state.error && sender.firstName === "" && "Champs obligatoire"
                      }
                      disabled={currentUser?.uid}
                  ...
                  <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                    <TextField
                      ...
                      size="small"
                      helperText={
                        state.error && sender.lastName === "" && "Champs obligatoire"
                      }
                  ...
                  <Grid container mb={2} rowSpacing={2} columnSpacing={4}>
                    ...
                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                      <TextField
                        ...
                        size="small"
                        error={
                          state.error && isReceiver === "no" && receiver.firstName === ""
                        }
                        helperText={
                          state.error &&
                          isReceiver === "no" &&
                    ...
                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                      <TextField
                        ...
                        size="small"
                        error={
                          state.error && isReceiver === "no" && receiver.lastName === ""
                        }
                        helperText={
                          state.error &&
                          isReceiver === "no" &&
